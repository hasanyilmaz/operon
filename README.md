...
Operon supports **eleven interface languages**: English, Turkish, German, French, Spanish, Simplified Chinese, Traditional Chinese, Japanese, Russian, Italian, and Brazilian Portuguese. English is built in; the other ten languages install as small on-demand packs. Natural-language date input is available in ten languages; Brazilian Portuguese currently uses the English date-language fallback.
