...
async function run(): Promise<void> {
	...
	ok(cssSource.includes('.operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) .operon-table-progress-cell.is-details-mode > .operon-table-progress-wrap .operon-task-progress-segment'));
	ok(cssSource.includes('.operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) .operon-table-progress-cell > .operon-table-progress-ring'));
	...
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) .operon-table-description-text:not(.is-empty)'));
	...
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) .operon-table-cell-chip:not(.operon-table-file-property-checkbox):not(.operon-table-parent-task-chip):not(.operon-table-field-accent-chip)'));
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) .operon-table-parent-task-chip'));
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) .operon-table-duration-like-chip'));
	ok(!cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) button.operon-table-source-button {\n\t\tbackground: var(--background-modifier-hover);'));
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) .operon-table-icon-only-button'));
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) button.operon-table-file-property-checkbox'));
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) .operon-table-progress-action-shell.is-details-mode .operon-task-progress-segment'));
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) .operon-table-field-accent-chip:not(.operon-table-file-property-checkbox)'));
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) button.operon-table-file-property-checkbox:not(:disabled) {\n\t\tborder-color: var(--interactive-accent);'));
	ok(cssSource.includes('background: transparent;\n\t\tbackground-color: transparent;\n\t\tcolor: var(--text-normal);'));
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) button.operon-table-task-icon-button:disabled,'));
	ok(cssSource.includes('body:not(.is-mobile) .operon-table-root .operon-table-row:is(:hover, .is-operon-linked-row-hover, .is-operon-table-refresh-hover) button.operon-table-task-icon-button.is-readonly {'));
