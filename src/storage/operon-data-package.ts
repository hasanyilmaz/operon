	...
	return {
		...
		ui: {
			...
			taskUiPreferences: {
				...
				assigneeImageProperty: normalized.assigneeImageProperty,
			...
			taskCreationProfile: {
				...
				inlineToFileTaskSourceDisposition: normalized.inlineToFileTaskSourceDisposition,
				...
				inheritPropertiesOnParentLink: normalized.inheritPropertiesOnParentLink,
