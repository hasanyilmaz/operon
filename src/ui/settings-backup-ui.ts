...
const SETTINGS_BACKUP_VAULT_REFERENCE_LABELS = {
	...
	dailyNoteTemplate: { namespace: 'settings', key: 'dailyNoteTemplate' },
	dailyNoteFolder: { namespace: 'settings', key: 'dailyNoteFolder' },
	weeklyNoteTemplate: { namespace: 'settings', key: 'weeklyNoteTemplate' },
	weeklyNoteFolder: { namespace: 'settings', key: 'weeklyNoteFolder' },
