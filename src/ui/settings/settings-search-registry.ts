...
export const OPERON_SETTINGS_SEARCH_REGISTRY: readonly OperonSettingsSearchEntry[] = [
	...
	e('settings', 'coreGeneral', 'operonDocsAutoUpdateEnabled', 'settings', 'operonDocsAutoUpdateEnabled', 'operonDocsAutoUpdateEnabledDesc', 'toggle', ['docs', 'documentation', 'wiki', 'auto update docs', 'official docs']),
