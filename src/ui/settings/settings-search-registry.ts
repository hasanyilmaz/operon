...
export const OPERON_SETTINGS_SEARCH_REGISTRY: readonly OperonSettingsSearchEntry[] = [
	...
	e('automation', 'tasksTaskRouter', 'inlineTaskSaveMode', 'settings', 'inlineTaskDefaultSavePath', 'inlineTaskDefaultSavePathDesc', 'dropdown', ['new task', 'task creator', 'inline task', 'inline save path', 'active file']),
	e('automation', 'tasksTaskRouter', 'inlineTaskTargetFile', 'settings', 'inlineTaskTargetFile', 'inlineTaskTargetFileSearchDesc', 'file', ['new task', 'task creator', 'inline task', 'specific file']),
	e('automation', 'tasksTaskRouter', 'inlineTaskHeading', 'settings', 'inlineTaskHeading', 'inlineTaskHeadingDesc', 'text', ['new task', 'task creator', 'inline task', 'heading', 'section']),
	e('automation', 'tasksTaskRouter', 'inlineTaskParentInlineTargetMode', 'settings', 'inlineParentTaskTargetMode', 'inlineParentTaskTargetModeDesc', 'dropdown', ['new task', 'task creator', 'inline task', 'parent', 'parent placement', 'inline parent']),
	e('automation', 'tasksTaskRouter', 'inlineTaskParentFileTargetMode', 'settings', 'fileParentTaskTargetMode', 'fileParentTaskTargetModeDesc', 'dropdown', ['new task', 'task creator', 'inline task', 'file task', 'parent', 'parent placement']),
	e('automation', 'tasksTaskRouter', 'inlineTaskParentFileHeadingKeyword', 'settings', 'parentFileHeadingKeyword', 'parentFileHeadingKeywordDesc', 'text', ['new task', 'task creator', 'inline task', 'parent file heading']),
	...
	e('automation', 'tasksTaskRouter', 'fileTasksFolder', 'settings', 'fileTasksFolder', 'fileTasksFolderDesc', 'folder', ['new task', 'task creator', 'file task', 'file task folder']),
	section('automation', 'tasksTaskRouter', 'fileTaskPipelineLocations', 'settings', 'fileTaskPipelineLocations', 'fileTaskPipelineLocationsDesc', ['file task', 'pipeline', 'pipeline folder', 'pipeline location', 'task router']),
	e('automation', 'tasksTaskRouter', 'moveConvertedNotesToPipelineLocation', 'settings', 'moveConvertedNotesToPipelineLocation', 'moveConvertedNotesToPipelineLocationDesc', 'toggle', ['file task', 'pipeline', 'convert notes', 'move converted notes', '5 seconds']),
	e('automation', 'tasksTaskRouter', 'fileTaskParentInlineTargetMode', 'settings', 'fileTaskInlineParentTargetMode', 'fileTaskInlineParentTargetModeDesc', 'dropdown', ['new task', 'task creator', 'file task', 'inline task', 'parent', 'parent placement']),
	e('automation', 'tasksTaskRouter', 'fileTaskParentFileTargetMode', 'settings', 'fileTaskFileParentTargetMode', 'fileTaskFileParentTargetModeDesc', 'dropdown', ['new task', 'task creator', 'file task', 'parent', 'parent placement']),
	...
	e('automation', 'tasksFileTasks', 'inlineToFileTaskSourceDisposition', 'settings', 'inlineToFileTaskSourceDisposition', 'inlineToFileTaskSourceDispositionDesc', 'dropdown', ['convert to file', 'inline task conversion', 'source note', 'keep link', 'remove original task']),
	...
	e('automation', 'tasksFileTasks', 'manageDailyNotesWithOperon', 'settings', 'manageDailyNotesWithOperon', 'manageDailyNotesWithOperonDesc', 'toggle', ['daily notes', 'periodic notes', 'Operon management']),
	e('automation', 'tasksFileTasks', 'dailyNoteFormat', 'settings', 'dailyNoteFormat', 'dailyNoteFormatDesc', 'text', ['daily notes', 'periodic notes', 'date format', 'moment format']),
	e('automation', 'tasksFileTasks', 'dailyNoteTemplate', 'settings', 'dailyNoteTemplate', 'dailyNoteTemplateDesc', 'file', ['daily notes', 'periodic notes', 'template']),
	e('automation', 'tasksFileTasks', 'dailyNoteFolder', 'settings', 'dailyNoteFolder', 'dailyNoteFolderDesc', 'folder', ['daily notes', 'periodic notes', 'folder']),
	...
	e('automation', 'tasksFileTasks', 'manageWeeklyNotesWithOperon', 'settings', 'manageWeeklyNotesWithOperon', 'manageWeeklyNotesWithOperonDesc', 'toggle', ['weekly notes', 'periodic notes', 'Operon management']),
	e('automation', 'tasksFileTasks', 'weeklyNoteFormat', 'settings', 'weeklyNoteFormat', 'weeklyNoteFormatDesc', 'text', ['weekly notes', 'periodic notes', 'week format', 'moment format']),
	...
	e('views', 'viewsTables', 'tableDefaultFolder', 'settings', 'tableDefaultFolder', 'tableDefaultFolderDesc', 'folder', ['table', 'operon table', 'table file', 'table folder', 'new table location', 'default creation folder']),
	...
	e('views', 'viewsTables', 'tableEmbedDefaultWidthPercent', 'settings', 'tableEmbedDefaultWidthPercent', 'tableEmbedDefaultWidthPercentDesc', 'dropdown', ['table', 'operon table', 'embedded table', 'embed width', 'table width', 'readable width', 'default width']),
	...
	e('views', 'viewsTables', 'tableShowTaskDataTypeIcon', 'settings', 'tableShowTaskDataTypeIcon', 'tableShowTaskDataTypeIconDesc', 'toggle', ['table', 'operon table', 'task data type', 'inline task', 'file task', 'data type icon', 'admin columns', 'administrative columns']),
