...
export const OPERON_SETTINGS_SEARCH_REGISTRY: readonly OperonSettingsSearchEntry[] = [
	...
	e('settings', 'tasksUpcoming', 'upcomingCountdownDisplay', 'settings', 'upcomingCountdownDisplay', 'upcomingCountdownDisplayDesc', 'dropdown', ['upcoming', 'countdown', 'seconds', 'hover']),
	e('settings', 'tasksUpcoming', 'upcomingDays', 'settings', 'upcomingDays', 'upcomingDaysDesc', 'dropdown', ['upcoming', 'scheduled', 'due', 'countdown']),
	e('settings', 'tasksUpcoming', 'upcomingShowAllDayTasks', 'settings', 'upcomingShowAllDayTasks', 'upcomingShowAllDayTasksDesc', 'toggle', ['upcoming', 'scheduled', 'due', 'countdown']),
	e('settings', 'tasksUpcoming', 'upcomingDailyGroupOrder', 'settings', 'upcomingDailyGroupOrder', 'upcomingDailyGroupOrderDesc', 'dropdown', ['upcoming', 'scheduled', 'due', 'countdown']),
	e('settings', 'tasksUpcoming', 'upcomingSidebarSide', 'settings', 'upcomingSidebarSide', 'upcomingSidebarSideDesc', 'dropdown', ['upcoming', 'scheduled', 'due', 'countdown']),
	e('settings', 'tasksUpcoming', 'upcomingTaskColorSource', 'settings', 'upcomingTaskColorSource', 'upcomingTaskColorSourceDesc', 'dropdown', ['upcoming', 'scheduled', 'due', 'countdown']),
	e('settings', 'tasksUpcoming', 'upcomingShowStatusBar', 'settings', 'upcomingShowStatusBar', 'upcomingShowStatusBarDesc', 'toggle', ['upcoming', 'scheduled', 'due', 'countdown']),
	e('settings', 'tasksUpcoming', 'upcomingStatusBarExpiryAction', 'settings', 'upcomingStatusBarExpiryAction', 'upcomingStatusBarExpiryActionDesc', 'dropdown', ['status bar', 'countdown', 'expired', 'next']),
	e('settings', 'tasksUpcoming', 'upcomingStatusBarClickAction', 'settings', 'upcomingStatusBarClickAction', 'upcomingStatusBarClickActionDesc', 'dropdown', ['status bar', 'click', 'timer', 'editor']),
	...
	e('ui', 'interfaceTaskChips', 'inlineTaskShowNoteAction', 'settings', 'inlineTaskNoteAction', 'inlineTaskIconsSectionDesc', 'toggle', ['task chips', 'inline task actions', 'note action', 'not']),
		...
		section('ui', 'interfaceTaskChips', 'taskCardChips', 'settings', 'taskCardChips', 'taskCardChipsDesc', ['task chips', 'task card chips', 'task card chips', 'task card icons', 'compact chips']),
		e('ui', 'interfaceTaskChips', 'taskCardShowPlayAction', 'settings', 'inlineTaskPlayAction', 'taskCardPlayActionDesc', 'toggle', ['task chips', 'task card actions', 'task card actions', 'timer', 'play action']),
		e('ui', 'interfaceTaskChips', 'taskCardShowPinAction', 'settings', 'inlineTaskPinAction', 'taskCardPinActionDesc', 'toggle', ['task chips', 'task card actions', 'task card actions', 'pin action', 'sabitle']),
		e('ui', 'interfaceTaskChips', 'taskCardShowNoteAction', 'settings', 'inlineTaskNoteAction', 'taskCardNoteActionDesc', 'toggle', ['task chips', 'task card actions', 'task card actions', 'note action', 'not']),
		e('ui', 'interfaceTaskChips', 'taskCardShowSubtaskAction', 'settings', 'inlineTaskSubtaskAction', 'taskCardSubtaskActionDesc', 'toggle', ['task chips', 'task card actions', 'task card actions', 'subtask action', 'alt görev']),
		e('ui', 'interfaceTaskChips', 'taskCardShowPlainCheckboxAction', 'settings', 'kanbanTaskOpenCheckboxAction', 'taskCardOpenCheckboxActionDesc', 'toggle', ['task chips', 'task card actions', 'task card actions', 'plain checkbox', 'normal checkbox', 'onay kutusu']),
	...
	e('ui', 'interfaceStateIcons', 'taskIconClickAction', 'settings', 'taskIconClickAction', 'taskIconClickActionDesc', 'dropdown', ['task icon', 'click', 'tap', 'pipeline', 'state', 'completion']),
