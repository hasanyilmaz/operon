...
export const OPERON_SETTINGS_SEARCH_REGISTRY: readonly OperonSettingsSearchEntry[] = [
	...
	e('views', 'viewsGantt', 'tableGanttDefaultBarColorMode', 'settings', 'ganttDefaultBarColor', 'ganttDefaultBarColorDesc', 'dropdown', ['gantt', 'bar color', 'task color', 'priority color']),
