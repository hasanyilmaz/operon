...
export const OPERON_SETTINGS_SEARCH_REGISTRY: readonly OperonSettingsSearchEntry[] = [
	...
	e('ui', 'interfaceTaskFinder', 'taskFinderRecentModifiedDays', 'settings', 'taskFinderRecentModifiedDays', 'taskFinderRecentModifiedDaysDesc', 'number', ['task finder', 'recent modified', 'recent tasks']),
	e('ui', 'interfaceTaskFinder', 'taskFinderVisibleResultCount', 'settings', 'taskFinderVisibleResultCount', 'taskFinderVisibleResultCountDesc', 'number', ['task finder', 'visible results', 'result rows']),
	...
	e('ui', 'mobileCalendar', 'calendarMobileSlotMinutes', 'settings', 'calendarMobileSlotMinutes', 'calendarMobileSlotMinutesDesc', 'number', ['mobile', 'phone', 'mobile calendar slot size', 'slot size', 'time grid']),
	...
	e('ui', 'mobileCalendar', 'calendarMobileAgendaPastDays', 'settings', 'calendarMobileAgendaPastDays', 'calendarMobileAgendaPastDaysDesc', 'number', ['mobile', 'phone', 'mobile agenda', 'agenda past days']),
	e('ui', 'mobileCalendar', 'calendarMobileAgendaFutureDays', 'settings', 'calendarMobileAgendaFutureDays', 'calendarMobileAgendaFutureDaysDesc', 'number', ['mobile', 'phone', 'mobile agenda', 'agenda future days']),
