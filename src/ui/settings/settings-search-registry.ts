...
export const OPERON_SETTINGS_SEARCH_REGISTRY: readonly OperonSettingsSearchEntry[] = [
	...
	e('automation', 'tasksRelationships', 'autoExpandParentTaskDateRange', 'settings', 'autoExpandParentTaskDateRange', 'autoExpandParentTaskDateRangeDesc', 'toggle', ['parent task', 'date range', 'start date', 'due date', 'descendants', 'relationships']),
