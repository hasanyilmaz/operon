...
| npm | `@stratejya/operon-cli@1.0.9` is published with provenance from the standalone repository | Exact published artifacts and provenance are verified before plugin release acceptance |
