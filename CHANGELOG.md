...
- Local Plugin and Runtime checks, production build, and release guard passed; the local regression suite passed **2,312/2,312** tests, including Pool value sources, link/media references, preference compatibility, tablet interactions, and inline/YAML schedule and gallery Undo/Redo. The related settings preservation, version backup, restore, and reset checks passed **201/201** tests.
