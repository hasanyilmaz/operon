...
- Improved **Table** wheel and trackpad scrolling to reduce lag in wide tables.

### Validation

- Local Plugin and Runtime checks, production build, and release guard passed, along with **3,381/3,381** local regression tests.
