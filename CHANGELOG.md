...
- Added the **Operon Group rule foundation** for single-property Canvas group titles, with text/list validation, safe value comparison, and optional card tracking metadata. Group creation, dropping tasks, and automatic movement are not enabled in this stage.
